...
```
	This repository is a challenge about solvig some errors in
	different programs with different languages and errors.
```

### 0. FizzBuzz

Please take a look at my implementation of FizzBuzz in Python: [source code](https://github.com/alx-tools/Fix-my-code-0/blob/master/0-fizzbuzz.py)
...
[Abdelemjid Essaid](https://github.com/abdelemjidessaid/0x00-challenge)
